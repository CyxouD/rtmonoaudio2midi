...
WINDOW_SIZE = 2048
LOCAL_MEAN_THRESHOLD = 100000 # TODO do not make it constant? 'e is the threshold above the local mean which an onset must reach' (https://pdfs.semanticscholar.org/2f5d/2c3884181f19a78efc17ce07c54f249edb0e.pdf)
