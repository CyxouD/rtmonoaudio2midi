...
class Tabulature:
    @staticmethod
    def show(notation, fundamental_frequencies_infos):
        ...
        LilyPond.to_pdf(lyString, "lilypond_generated/my_first_bar")


if __name__ == '__main__':
    result = StreamProcessor(
        "./test_data/IDMT-SMT-GUITAR_V2/dataset2/audio/AR_Lick1_KN.wav",
        bits_per_sample=24).run()
    Tabulature.show('tablature', result.fundamental_frequencies_infos)
